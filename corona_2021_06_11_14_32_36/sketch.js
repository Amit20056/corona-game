...
function preload(){
  mario_running = loadAnimation("boy0.png","boy1.png","boy2.png","boy3.png");
  mario_collided = loadAnimation("boy2.png");
  groundImage = loadImage("backg.jpg");
  
  coinImage = loadImage("mask.png");
  obstacle2 = loadImage("virus2.png");
  obstacle1 = loadImage("virus1.png");
  obstacle3 = loadImage("virus3.png");
...
function setup() {
  ...
  mario = createSprite(50,185,20,50);
  mario.addAnimation("running", mario_running);
  mario.scale = 0.3;
  mario.debug = true
  mario.setCollider("rectangle",0,0,100,150)
